...
<form action="{{ url('produk/update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="text3" name="harga_beli" type="text" class="form-control" value="{{ $pr->harga_beli }}">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="text5" name="min_stok" type="text" class="form-control" value="{{ $pr->min_stok }}">
        </div>
    </div>
    <div class="form-group row">
